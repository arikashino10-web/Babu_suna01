module.exports = {
  config: {
    ...
    shortDescription: { en: "Bot will reply when someone tags admins" },
    longDescription: { en: "Bot will reply with random funny messages when someone tags any of the specified admins" },
    category: "Other",
    guide: { en: "@" }
  },

  onStart: async function () {
    // এটি খালি থাকবে কারণ এটি মেসেজ বা মেনশন আসার সাথে সাথে (onChat) কাজ করবে
  },

  onChat: async function ({ message, event }) {
    const adminIDs = ["100089047474463", "100001039692046", "100044713412032"].map(String);
    
    // মেসেজ যদি কোনো এডমিন নিজেই পাঠায়, তবে বট কোনো রিপ্লাই দেবে না
    ...
    if (isMentioningBoss) {
      ...
      // আপনার বটের আসল নিয়ম অনুযায়ী মেসেজ পাঠানো
